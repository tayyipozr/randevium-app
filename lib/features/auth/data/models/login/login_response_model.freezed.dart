...
abstract class $LoginResponseModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String token, DateTime expiration});
}
...
class _$LoginResponseModelImpl implements _LoginResponseModel {
  const _$LoginResponseModelImpl(this.token, this.expiration);
  ...
  @override
  String toString() {
    return 'LoginResponseModel(token: $token, expiration: $expiration)';
  }
...
abstract class _LoginResponseModel implements LoginResponseModel {
  const factory _LoginResponseModel(
      final String token, final DateTime expiration) = _$LoginResponseModelImpl;
