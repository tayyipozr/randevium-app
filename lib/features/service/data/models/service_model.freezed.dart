...
abstract class $ServiceModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? name, String? description, int? cost, int? companyId});
}
...
class _$ServiceModelImpl implements _ServiceModel {
  const _$ServiceModelImpl(
      this.name, this.description, this.cost, this.companyId);
  ...
  @override
  String toString() {
    return 'ServiceModel(name: $name, description: $description, cost: $cost, companyId: $companyId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, description, cost, companyId);
...
abstract class _ServiceModel implements ServiceModel {
  const factory _ServiceModel(final String? name, final String? description,
      final int? cost, final int? companyId) = _$ServiceModelImpl;
